...
| Agregados de Cadastro (Cliente e Veículo) e o VO Contato | guardam as invariantes que sustentam a identificação do cliente e os dois CRUDs de cadastro: Documento válido, Placa válida, e-mail obrigatório porque é o destino do envio do Orçamento, e a Remoção lógica do ADR-014 |
